...
export class WhatsAppProvider implements ChannelProvider {
  ...
  get templates() {
    return {
      sync:         this.templatesService.sync.bind(this.templatesService),
      list:         this.templatesService.list.bind(this.templatesService),
      getVariables: this.templatesService.getVariables.bind(this.templatesService),
      preview:      this.templatesService.preview.bind(this.templatesService),
      build:        this.templatesService.build.bind(this.templatesService),
    };
  }
  ...
  private parseMessage(msg: any, val: any): ParsedInbound | null {
    ...
    switch (msg.type) {
      ...
      case 'document':
        return { ...base, messageType: 'document', attachments: [{
          type:            'document',
      ...
      case 'sticker':
        return { ...base, messageType: 'sticker', attachments: [{
          type:            'sticker',
      ...
      case 'location':
        return { ...base, messageType: 'location', attachments: [{
          type:            'location',
      ...
      case 'contacts':
        return { ...base, messageType: 'contact', attachments: (msg.contacts ?? []).map((c: any) => ({
          type:         'contact',
      ...
      case 'reaction':
        return { ...base, messageType: 'reaction', attachments: [{
          type:                'reaction',
